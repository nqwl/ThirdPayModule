...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = 'ThirdPayModule详情'

  s.homepage         = 'https://gitee.com/nqwl_chenhui'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'nqwl' => '1273087648@qq.com' }
  s.source           = { :git => 'https://gitee.com/nqwl_chenhui/ThirdPayModule.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'ThirdPayModule/Classes/**/*'
